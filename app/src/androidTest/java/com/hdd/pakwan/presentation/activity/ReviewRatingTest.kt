    ...
    fun reviewRatingTest() {
        ...
        val recyclerView = onView(
            allOf(
                ...
                childAtPosition(
                    withId(R.id.swipeDownToRefresh),
                    0
                )
            )
        )
        ...
        val materialButton = onView(
            allOf(
                withId(R.id.ard_add_review), withText("Add Review"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("android.widget.LinearLayout")),
                        0
        ...
        appCompatEditText3.perform(replaceText("New Review"), closeSoftKeyboard())

        val appCompatImageView = onView(
            allOf(
                withId(R.id.ratingStar3),
                childAtPosition(
                    allOf(
                        withId(R.id.ratingStarContainer),
                        childAtPosition(
        ...
        val materialButton2 = onView(
            allOf(
                withId(R.id.arl_ok), withText("Ok"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("androidx.constraintlayout.widget.ConstraintLayout")),
                        3
