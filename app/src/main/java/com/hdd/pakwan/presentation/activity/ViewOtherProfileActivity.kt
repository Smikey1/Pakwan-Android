...
import com.hdd.pakwan.presentation.fragments.*
...
class ViewOtherProfileActivity : AppCompatActivity() {
    ...
    private lateinit var ap_recipeCounter: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ap_recipeCounter = findViewById(R.id.ap_recipeCounter)
            ...
            try {
                ...
                if (response.success == true) {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        ap_recipeCounter.text=user.recipe!!.size.toString()
                        ...
                        tabTitleList = arrayListOf<String>("Post", "Recipe")
                        fragmentList = arrayListOf<Fragment>(ViewOtherPostFragment(user),ViewOtherRecipeFragment(user))
